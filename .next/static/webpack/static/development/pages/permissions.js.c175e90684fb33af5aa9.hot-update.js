      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
          ...
          onChange: function onChange(e) {
            if (e.target.checked) {
              var newPermissions = _toConsumableArray(_this2.state.permissions).concat([permission]);

              _this2.setState({
                permissions: newPermissions
              });
            } else {
              var _newPermissions = _this2.state.permissions.filter(function (perm) {
...
//# sourceMappingURL=permissions.js.c175e90684fb33af5aa9.hot-update.js.map