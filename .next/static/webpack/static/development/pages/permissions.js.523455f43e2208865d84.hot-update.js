...
function (_React$Component) {
  ...
  function UserPermissions() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handlePermissionChange", function (e) {
      ...
      var updatePermissions = _toConsumableArray(_this.state.permissions); // Figure out if you need to add or remove a permission
      ...
      if (checkbox.checked) {
        ...
        updatePermissions = updatePermissions.filter(function (perm) {
...
//# sourceMappingURL=permissions.js.523455f43e2208865d84.hot-update.js.map